...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@keyword.function.php"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@keyword.type.php"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@keyword.import.php"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@keyword.return.php"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@keyword.conditional.php"] = {fg = c.orange, fmt = cfg.code_style.keywords},
