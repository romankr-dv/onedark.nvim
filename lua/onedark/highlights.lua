...
hl.common = {
    ...
    FoldColumn = {fg = c.light_grey, bg = cfg.transparent and c.none or c.bg0},
    Folded = {fg = c.light_grey, bg = cfg.transparent and c.none or c.bg0},
...
hl.plugins.telescope = {
    ...
    TelescopePromptBorder= { fg=c.grey, bg =c.bg2 },
    TelescopePromptCounter= { fg=c.light_grey },
    TelescopeResultsNormal = { bg =c.bg2 },
    TelescopeResultsBorder= { fg=c.grey, bg =c.bg2 },
    ...
    TelescopePreviewBorder = { fg=c.grey, bg=c.bg1 },
