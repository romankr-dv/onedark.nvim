...
hl.common = {
    ...
    FoldColumn = {fg = c.light_grey},
    Folded = {fg = c.light_grey},
    SignColumn = {fg = c.fg},
    ToolbarLine = {fg = c.fg},
    Cursor = {fmt = "reverse"},
    vCursor = {fmt = "reverse"},
    ...
    LineNr = {fg = util.blend(c.grey, c.bg0, 0.7)},
    ...
    DiffDelete = {fg = c.grey, fmt = cfg.code_style.comments},
    ...
    StatusLineTerm = {fg = util.blend(c.fg, c.grey, 0.9), bg = c.bg1},
    ...
    FloatBorder = { fg=util.blend(c.grey, c.bg1, 0.5), bg =c.bg1 },
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@function.builtin.lua"] = hl.syntax.Function,
        ["@function.macro"] = {fg = c.yellow, fmt = cfg.code_style.functions},
        ...
        ["@keyword.import"] = colors.Orange,
        ["@keyword.operator"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@keyword.repeat"] = {fg = c.orange, fmt = cfg.code_style.keywords},
        ["@label"] = colors.Fg,
        ...
        ["@markup.strike"] = {fg = c.fg},
        ["@markup.strikethrough"] = {fg = c.fg},
        ["@markup.strong"] = {fg = c.fg},
        ["@markup.underline"] = {fg = c.fg},
        ["@markup.italic"] = {fg = c.fg},
        ["@module"] = colors.Fg,
        ["@module.builtin"] = colors.Pink,
        ["@none"] = colors.Fg,
        ["@number"] = colors.Cyan,
        ["@number.float"] = colors.Cyan,
        ["@operator"] = colors.Fg,
        ["@parameter.reference"] = colors.Fg,
        ["@property"] = colors.Fg,
        ["@property.go"] = colors.Pink,
        ["@property.json"] = colors.Pink,
        ["@property.php"] = colors.Pink,
        ...
        ["@type.sql"] = colors.Fg,
        ["@type.definition"] = colors.Fg,
        ["@type.builtin"] = colors.Orange,
        ["@variable"] = {fg = c.fg, fmt = cfg.code_style.variables},
        ["@variable.builtin"] = {fg = c.pink, fmt = cfg.code_style.variables},
        ["@variable.member"] = colors.Pink,
        ...
        ["@annotation.phpdoc"] = {fg = c.grey, fmt = "italic"},
...
hl.plugins.telescope = {
    ...
    TelescopePromptBorder= { fg=util.blend(c.grey, c.bg2, 0.5), bg =c.bg2 },
    ...
    TelescopeResultsDiffUntracked = { fg=c.blue },
...
hl.plugins.lazy = {
    ...
    LazyReasonEvent = colors.Cyan,
    LazyReasonStart = colors.Pink,
    LazyReasonCmd = colors.Yellow,
    LazyReasonFt = colors.Yellow,
    LazyReasonImport = colors.Red,
    LazyReasonKeys = colors.Pink,
    LazyReasonRuntime = colors.Red,
}
