...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@constructor"] = {fg = c.fg, fmt = cfg.code_style.functions},
        ...
        ["@keyword.conditional"] = hl.syntax.Keyword,
        ["@keyword.directive"] = hl.syntax.Keyword,
        ["@keyword.exception"] = hl.syntax.Keyword,
        ["@keyword.function"] = hl.syntax.Keyword,
        ["@keyword.import"] = hl.syntax.Keyword,
        ...
        ["@tag.builtin.tsx"] = hl.syntax.Tag,
        ["@tag.delimiter.tsx"] = hl.syntax.Tag,
        ["@variable.member.go"] = colors.Fg,
        ["@type.definition.go"] = colors.Fg,
...
hl.plugins.lazy = {
    ...
    LazyReasonSource = colors.Orange,
    LazyReasonPlugin = colors.Red,
    LazyReasonEvent = colors.Cyan,
    LazyReasonStart = colors.Purple,
    LazyReasonCmd = colors.Orange,
    LazyReasonFt = colors.Orange,
