...
hl.common = {
    ...
    LineNr = {fg = util.blend(c.grey, c.bg1, 0.8)},
...
hl.plugins.telescope = {
    ...
    TelescopePromptBorder= { fg=util.blend(c.fg, c.bg2, 0.2), bg =c.bg2 },
    TelescopePromptCounter= { fg=c.light_grey },
    TelescopeResultsNormal = { bg =c.bg2 },
    TelescopeResultsBorder= { fg=util.blend(c.fg, c.bg2, 0.2), bg =c.bg2 },
    ...
    TelescopePreviewBorder = { fg=c.bg4, bg=c.bg1 },
